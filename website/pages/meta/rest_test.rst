...
In other words, this page is for testing feature implementations. For recommendation how to write pages using reStructuredText check `reST examples <link://filename/pages/meta/rest_examples.rst>`__.
